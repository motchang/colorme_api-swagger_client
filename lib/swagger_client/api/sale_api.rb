...
module SwaggerClient
  class SaleApi
    ...
    def cancel_sale_with_http_info(sale_id, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'restock'])
      auth_names = ['OAuth2']
    ...
    def send_sales_mail_with_http_info(sale_id, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'mail'])
      auth_names = ['OAuth2']
    ...
    def update_sale_with_http_info(sale_id, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'sale'])
      auth_names = ['OAuth2']
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
