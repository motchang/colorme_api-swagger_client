...
module SwaggerClient
  ...
  class Shop
    ...
    def valid?
      ...
      open_state_validator = EnumAttributeValidator.new('String', ["opened", "closed", "prepare"])
      return false unless open_state_validator.valid?(@open_state)
      mobile_open_state_validator = EnumAttributeValidator.new('String', ["opened", "closed", "prepare"])
    ...
    def open_state=(open_state)
      validator = EnumAttributeValidator.new('String', ["opened", "closed", "prepare"])
