...
module SwaggerClient
  ...
  class InlineResponse20014Gift
    ...
    def self.swagger_types
      {
        :'account_id' => :'String',
        :'enabled' => :'BOOLEAN',
        :'noshi' => :'InlineResponse20014GiftNoshi',
        :'card' => :'InlineResponse20014GiftCard',
        :'wrapping' => :'InlineResponse20014GiftWrapping',
        :'make_date' => :'Integer',
        :'update_date' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'wrapping')
